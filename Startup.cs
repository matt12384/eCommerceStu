...
namespace eCommerceStu
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<EcommerceStuContext>(options =>                        
                options.UseSqlServer(Configuration.GetConnectionString("DefaultConnection")));

            services.AddIdentity<AppUser, AppRole>().AddEntityFrameworkStores<EcommerceStuContext>().AddDefaultTokenProviders();
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            StripeConfiguration.SetApiKey("sk_test_uyhTrCTdddAUKtEDMar62VIR");
        }
    }
}
