...
namespace eCommerceStu.Features.Products
{
    ...
    public class ProductsController : Controller
    {
        ...
        public ProductsController(EcommerceStuContext db)
        {
            _db = db;
        }
        ...
        public async Task<IActionResult> Find(string q, string brands, int? minPrice, int? maxPrice,
                                              int? minScreen, int? maxScreen, string capacity, 
                                              string colours, string os, string features)
        {
            ...
            var products = await _db.Products
                ...
                .Where(x => maxPrice.HasValue == false || x.ProductVariants.Any(v => v.Price <= maxPrice))
                ...
                .Where(x => Capacity.Any() == false || x.ProductVariants.Any(v => Capacity.Contains(v.Colour.Name)))
        ...
        [HttpGet("{slug}")]
        public async Task<IActionResult> GetAction(string slug)
        {
