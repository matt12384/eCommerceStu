...
namespace eCommerceStu.Data
{
  public static class DbContextExtensions
  {
    ...
    public static void EnsureSeeded(this EcommerceStuContext context)
    {
      AddRoles(context);
      AddUsers(context);
    ...
    private static void AddUsers(EcommerceStuContext context)
    {
    ...
    private static void AddRoles(EcommerceStuContext context)
    {
    ...
    private static void AddOperatingSystemsAndBrands(EcommerceStuContext context)
    {
    ...
    private static void AddProducts(EcommerceStuContext context)
    {
